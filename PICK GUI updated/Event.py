...
class eventConfiguration(QDialog):
    def __init__(self, parent=None):
        ...
        self.NameTextbox = QtWidgets.QPlainTextEdit(self)
        ...
        self.EventStartTextbox = QtWidgets.QPlainTextEdit(self)
        ...
        self.DescriptionTextbox = QtWidgets.QPlainTextEdit(self)
        ...
        self.EventEndTextbox = QtWidgets.QPlainTextEdit(self)
