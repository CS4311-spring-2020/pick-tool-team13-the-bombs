...
class Ui_EventConfig(object):
    def setupUi(self, EventConfig):
        ...
        self.gridLayout.addWidget(self.EventEndTextbox, 0, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.EventEndlabel, 0, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.NameTextbox, 0, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.EventNamelabel, 0, 2, 1, 1)
        self.EventStartTextbox = QtWidgets.QTextEdit(EventConfig)
        self.EventStartTextbox.setObjectName("EventStartTextbox")
        self.gridLayout.addWidget(self.EventStartTextbox, 1, 3, 1, 1)
